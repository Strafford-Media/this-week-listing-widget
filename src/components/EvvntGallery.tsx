...
const tabColors: any = {
  kauai: 'tw-bg-fuchsia-500 tw-ring-fuchsia-300',
  oahu: 'tw-bg-yellow-500 tw-ring-yellow-300',
  maui: 'tw-bg-pink-600 tw-ring-pink-300',
  hawaii: 'tw-bg-red-600 tw-ring-red-300',
}
...
function getTabClasses(island: string, tab: string) {
  ...
  return `tw-transition-all tw-cursor-pointer focus:tw-outline-none sm:focus:tw-ring-4 focus:tw-ring-2 tw-rounded-t-lg tw-flex tw-justify-center tw-items-center tw-text-sm tw-capitalize sm:tw-text-xl tw-font-bold tw-text-white ${
    tabColors[island] ?? ''
  } ${selectionClasses}`
}
